...
{
  // A simple, but inefficient algorithm, requiring O(n^2) time. Go through the
  // first list, and for each item, check if it is contained in the second list.
  // If so, then append it to the end of the result list.
