...
public:
  ...
  // precondition: ensures there is at least one course in the student's schedule
  // postcondition: revises student's schedule to omit the redacted course and
  // entirely removes the course from the course list.
