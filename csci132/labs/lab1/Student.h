...
private:
  ...
  std::string course1;      // first course
  std::string course2;      // second course
  std::string course3;      // third course
  std::string course4;      // fourth course
  std::string course5;      // fifth course
  std::string course6;      // sixth course
